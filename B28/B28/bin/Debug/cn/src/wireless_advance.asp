        ...
        <input type="hidden" name="GO" value="broadcast.asp" />
            <div class="myTable mt20">
                <div class="control-group">
                    <label class="control-label">Recognize Terminal Type</label>
                    <div class="controls">
                        <input type="radio" name="oltEn" value="false" />
                        Disable
                        <input type="radio" name="oltEn" value="true" checked="checked"  style="margin-left:10px;" />
                        Enable
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label">Filter Broadcast Data</label>
                    <div class="controls">
                        <input type="radio" name="broadcastEn" value="false" />
                        Disable
                        <input type="radio" name="broadcastEn" value="true"   style="margin-left:10px;" />
                        Enable
                    </div>
                </div>
                <div class="control-group" id="modeTable">
                    ...
                    <div class="controls">
                        <select name="filterMode" id="filterMode" size="1">
                            <option value="2">Only accept DHCP and ARP packets</option>
                            <option value="3">Only accept ARP packets</option>
                        </select>
                    </div>
                </div>
            </div>

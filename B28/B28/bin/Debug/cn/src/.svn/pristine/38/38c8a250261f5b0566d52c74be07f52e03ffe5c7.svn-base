		...
		<form action="/goform/setUplinkInfo" method="post" name="uplink">
			...
			<div class="myTable mt20">
				<div class="control-group">
					<label for="" class="control-label">Uplink Detection</label>
					<div class="controls">
						<input type="checkbox" name="upLinkEn" id="upLinkEn">Enable
					</div>
				</div>
				<div class="control-group">
					<label for="" class="control-label">Ping Host1</label>
					<div class="controls">
						<input type="text" id="pingHostIp1" name="pingHostIp1" size="15" maxlength="15">
					</div>
				</div>
				<div class="control-group">
					<label for="" class="control-label">Ping Host2</label>
					<div class="controls">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" id="pingInterval" name="pingInterval" size="5" maxlength="3"><span class="text-help">10 ~ 100 Minutes</span>
					</div>
				</div>
			</div>
		</form>
...
/*var linkEn = "<%getLinkInfo("linkEn");%>",
	pingIp1 = "<%getLinkInfo("pingIp1");%>",
	pingIp2 = "<%getLinkInfo("pingIp2");%>",
	intervalTime = "<%getLinkInfo("intervalTime");%>"*/

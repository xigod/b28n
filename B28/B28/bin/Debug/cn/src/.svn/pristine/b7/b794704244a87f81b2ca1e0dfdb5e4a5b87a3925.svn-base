...
$(function () {
    ...
    var advance5g = {
        ...
        checkSupportSpite: function () {
            ...
            if (needNodes == 3) {
                alert(_("At least one basic rate option (6M, 12M or 24M) should be enabled."));
                return false;
            } else {
                return true;
            }
        ...
        checkValue: function () {
            ...
            if ($("[name=prio_5]:checked").val() == "1" && !checkRssiData(f.prio_5_value, _("5GHZ Threshold"), -90, -20)) {
                return false;
            }

		...
		<div class="w750">
			<form action="/goform/WifiMacFilterSet" method="post" name="wireless_filter">
				...
				<p class="w640 mt20 ml20">
					Specify a list of devices to allow or disallow a connection to your wireless network via the devices' MAC addresses. This can be set seperately on each SSID.
				</p>
				<div class="w640">
					...
					<div class="control-group">
						<label class="control-label">MAC Filter Mode</label>
						<div class="controls">
				...
				<table id="wrlFilter5G" width="640" border="1" class="ml20 tc table-td">
					<thead>
						<tr class="a3">
							<td width="10%">ID</td>
			...
			<table id="filterTab" class="w640 ml20 tc">
				...
				<tr>
					<td>
						<input type="text" class="input-mic-mini" name="mac1" size="2" maxlength="2"/>
						:
						<input type="text" class="input-mic-mini" name="mac2" size="2" maxlength="2" />
						:
						<input type="text" class="input-mic-mini" name="mac3" size="2" maxlength="2"/>
						:
						<input type="text" class="input-mic-mini" name="mac4" size="2" maxlength="2"/>
						:
						<input type="text" class="input-mic-mini" name="mac5" size="2" maxlength="2"/>
						:
						<input type="text" class="input-mic-mini" name="mac6" size="2" maxlength="2"/>
					</td>
					<td>

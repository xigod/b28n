...
<body class="topbody">
	...
	<div id="middle">
		<div id="top_right_title">
			<span id="userType">User Name:</span>
			[
			<span style="color: #FF0000;font-weight: bold;" id="userName">admin</span>
			]&nbsp;
			<span id="FirwareVerion"></span>
		</div>
		<div id="middle_left">
			<ul>
				<li class="Bborder">
				...
				<li class="Bborder">
					...
					<li>
						<span></span>
						<a data-test="wireless_basic.asp" id="wrl-basic">SSID Setup</a>
					</li>
					<li>
						<span></span>
						<a data-test="wireless_radio.asp" id="wrl-rd">Radio</a>
					</li>
					<li>
						<span></span>
						<a data-test="wireless_radioUp.asp" id="wrl-rdup">Radio Optimizing</a>
					</li>
					<li>
						<span></span>
					...
					<li>
						<span></span>
						<a data-test="wmmSetting.asp" id="wrl-WMM">WMM Setup</a>
					</li>
					<!--<li>
					<span></span>
		...
		<script>
		if (CONFIG_AP_MANAGE_V2 == 'y'||CONFIG_AP_MANAGE_V3 == 'y') {
		...
		<li class="Bborder" id="tool">
			...
			<ul  class="none ml20">
				<li>
					<span></span>
					<a data-test="system_upgrade.asp" id="sys-upgrade">Maintenance</a>
				</li>
				<li>
					<span></span>
					<a data-test="system_hostname.asp" id="sys-time">Time &amp; Date</a>
				</li>
				<li>
					<span></span>
				...
				<li>
					<span></span>
					<a data-test="system_password.asp" id="sys-password">Username & Password</a>
				</li>
				<li>
					<span></span>
					<a data-test="system_checktool.asp" id="sys-check">Diagnostics</a>
				</li>
				<li>
					<span></span>
				...
				<li>
					<span></span>
					<a data-test="system_led.asp" id="sys-led">LED</a>
				</li>
			</ul>
		</li>
	</ul>
...
<hr> <i>Copyright© 2017 by IP-COM Networks Co.,Ltd. All rights reserved.</i> 
</div>

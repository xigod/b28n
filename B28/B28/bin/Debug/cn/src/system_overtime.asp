		...
		<form method="post" name="frmform" action='/goform/setWebTimeout' id="system_overtime">
			<div class="myTable mt20">
				<div class="control-group"> 
					<label class="control-label">Login Timeout:</label>  
					<div class="controls"><input class="text" maxlength="2" name="timeoutTime" id="timeoutTime" style="width:40px" size="4" /><span class="text-help">(1~60 minutes)</span></div>
				</div>
			</div>
		</form>
		<div id="tail"></div>

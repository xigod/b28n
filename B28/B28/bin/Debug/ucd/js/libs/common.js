...
var statusMsg = {
    ...
    "0302": _("Disconnected"),
    "0303": _("Checking the user name and password... Please wait. It will take 1~2 minutes"),
    ...
    "1303": _("Checking the user name and password... Please wait. It will take 1~2 minutes"),
    ...
    //APClinet
    "2002": _("No bridge yet in Universal Repeater mode."),
    "2003": _("Bridging in Universal Repeater mode..."),
    "2004": _("Bridged successfully in Universal Repeater mode.")
};
...
function fillStatusString(code, id) {
    $("#" + id).html(statusMsg[code]);
}
...
function showWanInternetStatus(statusNumber, textId) {
    ...
    connectStatus = statusNumber.slice(1, 2);
    fillStatusColor(connectStatus, textId);
    fillStatusString(statusNumber.slice(3, 7), textId);

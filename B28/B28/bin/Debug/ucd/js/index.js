...
function MainLogic() {
	...
	function changeIcon(lang) {
		if (lang == "cn") {
			$("#iconLeft .nav-icon").attr("class", "nav-icon icon-weibo");
			$("#iconRight .nav-icon").attr("class", "nav-icon icon-wechat");
			$('.brand').attr('href', 'http://tenda.com.cn');
		} else {
			$("#iconLeft .nav-icon").attr("class", "nav-icon icon-facebook");
			$("#iconRight .nav-icon").attr("class", "nav-icon icon-twitter");
	...
	this.initEvent = function () {
		...
		$(document).on("click", function (e) {
			var target = e.target || e.srcElement,
				clickSetLang;
			if ($(target.parentNode).hasClass('addLang')) {

define(function (require, exports, module) {
	...
	pageModule.initEvent = function () {
		pageModule.update(5000, updateStatus);
	}
	...
	function WanModule() {
		...
		this.initValue = function () {
			...
			if (!this.addInputEvent) {
				...
				if ($("#wanPPPoEPwd_") && $("#wanPPPoEPwd_").length > 0) {
					$("#wan .placeholder-text").css("width", "270px");
				}
		...
		this.changeWanType = function () {
			...
			if (pageModule.data.wanType == wanType) {

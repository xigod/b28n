        ...
        <div class="w900">
            <form>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="radio" name="appEnable" value="0">Disable<input type="radio" name="appEnable" value="1">Enable</div>
                </div>
                <div id="appEnableShow">
                    <div class="control-group none">
                        <label class="control-label">P2P Filter</label>
                        <div class="controls">
                            <input type="radio" name="P2PFilter" value="0">Disable<input type="radio" name="P2PFilter" value="1">Enable</div>
                    </div>
                    <table class="myTable">
                        <tbody><tr id="appNodes">
                            <td>IM Filter</td>
                            <td>
                                <label>

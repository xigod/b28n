...
<div class="divbody">
	...
	<table width="640" class="ml20 mt20 none">
		<tbody><tr>
			<td>You need to reboot this device to enable your settings to take effect.</td>
		</tr>
		<tr>
			<td aligh="center">
			<input class="button" type="button" name="continue" onclick="history.back()" value="Back">
...
<script>var lanip = "<%aspTendaGetStatus("lan","lan_ip");%>",//"192.168.0.1",//
	sslenable = "<%aspTendaGetStatus("lan","lan_webiplansslen");%>",//0,//
	rebootUrl = sslenable == 0 ? ("http://" + lanip) : ("https://" + lanip),
	ipMode = "<%aspTendaGetStatus("lan","lan_connecttype");%>";</script>
</body></html>
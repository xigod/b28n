	...
	<div class="w750">
		...
		<table>
			...
			<tr id="tr-2">
				<td>星期</td>
				<td>
					<input type="checkbox" id="week1">一<input type="checkbox" id="week2">二<input type="checkbox" id="week3">三<input type="checkbox" id="week4">四<input type="checkbox" id="week5">五<input type="checkbox" id="week6">六<input type="checkbox" id="week7">七</td>
			</tr>
			<tr id="tr-3">
				<td>重启时间</td>
...
<script type="text/javascript">var enable = "<%aspAutoReboot("sys","schedulereboot_enable");%>",

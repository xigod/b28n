			...
			<form action="/goform/WifiAdvanceSet" method="post" name="wireless_advance">
				...
				<div class="myTable mt20">
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="beacon" name="beacon" size="5" maxlength="3">ms (Range: 100 to 999; Default: 100)</div>
					</div>
					<div class="control-group">
						<label class="control-label">Fragment Threshold</label>
						<div class="controls">
							<input type="text" id="fragment" name="fragment" size="5" maxlength="4">(Range: 256 to 2346; Default: 2346)</div>
					</div>
					<div class="control-group">
						<label class="control-label">RTS Threshold</label>
						<div class="controls">
							<input type="text" id="rts" name="rts" size="5" maxlength="4">(Range: 1 to 2347; Default: 2347)</div>
					</div>
					<div class="control-group">
						<label class="control-label">DTIM Interval</label>
						<div class="controls">
							<input type="text" id="dtim" name="dtim" size="5" maxlength="3">(Range: 1 to 255; Default: 1)</div>
					</div>
					<div class="control-group">
						<label class="control-label">Minimum RSSI Threshold</label>
						<div class="controls">
							<input type="text" id="RSSI" name="RSSI" size="5" maxlength="4">(dBm,Range: -90 - -60; Default: -90)</div>
					</div>
					<div class="control-group">
						...
						<div class="controls">
							...
							<span id="powerHelp">dBm (Range: 17 to 23; Default: 23)</span>
						</div>
					</div>
					...
					<div class="control-group none" id="div_ap_led" name="div_ap_led">
						...
						<div class="controls">
							<input type="radio" name="wrlLed" value="true" checked="">Enable<input type="radio" name="wrlLed" value="false" style="margin-left:10px;">Disable</div>
					</div>
					<div class="control-group">
						<label class="control-label">Preamble</label>
						<div class="controls">
							<input type="radio" name="Plcp" value="1" checked="">Long Preamble<input type="radio" name="Plcp" value="0" style="margin-left:10px;">Short Preamble</div>
					</div>
					<div class="control-group">
						<label class="control-label">Prioritize 5 GHz</label>
						<div class="controls">
							<input type="radio" name="prio_5" value="1" checked="">Enable<input type="radio" name="prio_5" value="0" style="margin-left:10px;">Disable</div>
					</div>
					<div class="control-group" id="atf_type_5g">
						<label class="control-label">Air Interface Scheduling</label>
						<div class="controls">
							<input type="radio" name="atf" value="1" checked="">Enable<input type="radio" name="atf" value="0" style="margin-left:10px;">Disable</div>
					</div>
				</div>
			</form>
			<div id="tail"></div>

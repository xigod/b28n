...
<div class="divbody">
	<div id="head"></div>
		...
		<div class="control-group">
			<label for="" class="control-label">Enable Reboot Schedule</label>
			<div class="controls">
				<input type="checkbox" id="en">
			</div>
		</div>
		<div class="control-group">
			<label for="" class="control-label">Reboot Mode</label>
			<div class="controls">
				<select id="sched_type">
					<option value="interval">At intervals</option>
					<option value="timing">At specified time</option>
				</select>
			</div>
		</div>
		<div class="control-group" id="tr-1">
			<label for="" class="control-label">Interval</label>
			<div class="controls">
				<input type="text" id="interval_time" onkeyup="filterV('interval_time');" value="1440"><span class="text-help;">m (Range: 10 to 7200)</span>
			</div>
		</div>
		<div class="control-group" id="tr-2">
			<label for="" class="control-label">Reboot On</label>
			<div class="controls">
				<label class="radio">
					<input type="checkbox" id="everyday">Every day</label>
				<label class="radio">
					<input type="checkbox" id="week1">Monday</label>
				<label class="radio">
					<input type="checkbox" id="week2">Tuesday</label>
				<label class="radio">
					<input type="checkbox" id="week3">Wednesday</label>
				<label class="radio">
					<input type="checkbox" id="week4">Thursday</label>
				<label class="radio">
					<input type="checkbox" id="week5">Friday</label>
				<label class="radio">
					<input type="checkbox" id="week6">Saturday</label>
				<label class="radio">
					<input type="checkbox" id="week7">Sunday</label>
			</div>
		</div>
		<div class="control-group" id="tr-3">
			<label for="" class="control-label">Reboot At</label>
			<div class="controls">
				<input type="text" id="time" size="5" value="11:59">
				<label style="display: inline-block;"><span class="text-help;">Example: 3:00</span></label>
			</div>
		</div>

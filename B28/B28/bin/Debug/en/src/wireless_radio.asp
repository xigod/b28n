			...
			<form action="/goform/WifiRadioSet" method="post" name="wireless_radio">
				...
				<div class="myTable mt20">
					...
					<div class="control-group" id="channelBand">
						...
						<div class="controls">
							<input type="radio" name="bandwidth" value="20">20<!--<label class="radioWrapper">
							-->
							<input type="radio" name="bandwidth" value="40">40<input type="radio" name="bandwidth" value="auto">20/40<!--</label>--></div>
					</div>
					...
					<div class="control-group none">
						...
						<div class="controls">
							<input type="radio" name="wmmEn" value="true">Enable<input type="radio" name="wmmEn" value="false" style="margin-left:10px;">Disable<input type="radio" name="wmmMode" value="2">
					...
					<div class="control-group">
						...
						<div class="controls">
							...
							<span id="powerHelp" class="text-help">dBm (Range: 10 to 20; Default: 20)</span>
						</div>
					</div>
					<div class="control-group">
					...
					<div class="control-group" id="chain_num">
						...
						<div class="controls">
							<input type="radio" name="txrxChain" value="1">1x1<input type="radio" name="txrxChain" value="2">2x2</div>
					</div>
					<div class="control-group" id="chain_port">
						<label class="control-label">Antenna</label>
						<div class="controls">
							<input type="radio" name="txrxChainPort" value="1">Antenna 0<input type="radio" name="txrxChainPort" value="2">Antenna 1</div>
					</div>
					<!-- <div class="control-group">

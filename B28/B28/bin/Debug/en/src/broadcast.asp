...
<html><head>
    ...
    <script>var broadcastEn = "<%getSysStatus("castFilterEn","Enable");%>";  // 0 1   表示开启或关闭
    var filterMode = "<%getSysStatus("castFilterEn","Mode");%>";  //1 2 3   表示三种模式</script>
</head>
                ...
                <div>
                    <table class="myTable mt20">
                            <tbody><tr>
                                ...
                                <td>
                                    <label class="pr20">
                                        <input type="radio" name="broadcastEn" value="0">Disable</label>
                                    <label class="pr20">
                                        <input type="radio" name="broadcastEn" value="1">Enable</label>
                                </td>
                            </tr>
                    </tbody></table>
                        ...
                        <tbody><tr>
                            ...
                            <td>
                                <select name="filterMode">
                                    <option value="1">Filter All</option>

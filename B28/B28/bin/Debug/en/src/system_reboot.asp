...
<div class="divbody">
	...
	<div style="margin:30px">
		<p>You can click the Reboot button to reboot this device immediately.</p>
...
<script>/*var lanip = "<%aspTendaGetStatus("lan","lan_ip");%>",
	reboot_sslenable = "<%aspTendaGetStatus("lan","lan_webiplansslen");%>",
	reboot_time = "<%aspTendaGetStatus("sys","reboot_time");%>";*/</script>
</body></html>
    ...
    if ($("#wlChannelScan").val() == _("Scan")) {
        if ($(".spendTime").val() == "") {
            ...
            if($(".spendTime").val() <= 1600){
                ...
                $(".conMsg").find("label").text(_("The scanning will take about 40 seconds. Please wait."));
            }else{
                $(".conMsg").find("label").text(_("The scanning will take about 50 seconds. Please wait."));
            }

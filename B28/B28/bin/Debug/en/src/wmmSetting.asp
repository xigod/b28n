            ...
            <form class="2g">
                ...
                <div class="myTable mt20">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="radio" name="wmmEn" value="false">Disable<input type="radio" name="wmmEn" value="true" style="margin-left:10px;">Enable</div>
                    </div>
                </div>
                <div id="wmmContent">
                    <div class="myTable">
                        <div class="control-group">
                            <label class="control-label">Optimization Mode</label>
                            <div class="controls">
                                <input type="radio" name="wmmMode" value="throughput">Optimized for scenario with 1 - 10 users</div>
                        </div>
                        <div class="control-group">
                            <label class="control-label"></label>
                            <div class="controls">
                                <input type="radio" name="wmmMode" value="capacity" checked="">Optimized for scenario with more than 10 users</div>
                        </div>
                        <div class="control-group">
                            <label class="control-label"></label>
                            <div class="controls">

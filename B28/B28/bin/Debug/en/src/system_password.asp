		...
		<div class="w750">
			<form name="frmSetup" method="post" action="/goform/SysToolChangePwdNew" id="system_password">
				...
				<table width="640" class="ml20 mt20 table-td">
					<tbody><tr>
						<td colspan="2" nowrap="nowrap">You can change your login user name and password here.<br>Note: Only 1～32 letters, digits, and underscores are allowed in a user name or password.</td>
					</tr>
				</tbody></table>
				<table id="userInfo" border="1" class="ml20 tc table-td">
					...
					<tr>
						...
						<td>
							<button type="button" class="button1 moduser button" name="modadmin">Edit</button>
						</td>
					</tr>
					<tr>
						<td>User</td>

			...
			<form action="/goform/setCloudApMngCfg" method="post" name="deploy">
				...
				<div class="myTable mt20">
					<div class="control-group">
						...
						<div class="controls">
							<input type="radio" name="deployType" value="local">Local<input type="radio" name="deployType" value="yun">Cloud</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="yunAcIp" name="yunAcIp" size="15" maxlength="256">(WAN IP address (public IP address) of the egress router to which the cloud AC connects, or domain name to which the WAN IP address is bound)</div>
					</div>
					<div class="control-group">
						<label class="control-label">Cloud AC Management Port</label>
						<div class="controls">
							<input type="text" id="yunAcManagePort" name="yunAcManagePort" size="5" maxlength="5">(Range: 1024 to 65535)</div>
					</div>
					<div class="control-group">
						<label class="control-label">Cloud AC Upgrade Port</label>
						<div class="controls">
							<input type="text" id="yunAcUpgradePort" name="yunAcUpgradePort" size="5" maxlength="5">(Range: 1024 to 65535)</div>
					</div>

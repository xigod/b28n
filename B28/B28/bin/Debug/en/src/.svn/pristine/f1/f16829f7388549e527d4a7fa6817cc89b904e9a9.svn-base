...
<div class="navbar-content login">
  ...
  <div class="btn-group">
    ...
    <div class="notice"> <a id="forgetpwd" >Forget your password?<span class="tip">Try the default user name and password. If they do not work, hold down the Reset button on the AP for about 8 seconds, wait about 1 minute, and log in to the AP again.</span></a> </div>
  </div>
</div>
<script>

		...
		<form name="SetSnmp" method="POST" action="/goform/SetSnmp" id="system_snmp">
			...
			<div class="myTable">
				<div class="control-group">
					...
					<div class="controls"><input type="radio" name="snmpEn" value="false" >Disable
						<input type="radio" name="snmpEn" value="true" checked="checked" >Enable</div>
				</div>
				<div id="snmpWrap" class="none">
					<div class="control-group none">
						<label class="control-label">SNMP Version</label>
						<div class="controls"><input type="radio" name="snmpVer" value="1" checked="checked" >
							SNMP V1&V2

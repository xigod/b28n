			...
			<!-- 802.1x -->
				...
				<div id="div_wpa" class="myTable none">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type='text' id="keyPeriod" name="keyPeriod" size="4" maxlength="5"/><span class="text-help" style="margin-left:3px;">
							s (Range: 60~99999 seconds. If set to 0, key will not be updated.)</span>
						</div>
					</div>
				</div>
			</form>

        ...
        <div class="w750">
            <form name="frmSetup" method="post" style="width:660px;" action="/goform/setQos">
                ...
                <div class="control-group" id="netCtrRadioList">
                    ...
                    <div class="controls">
                        <input type="radio" name="qosmode" value="0">
                        Disable (Default)
                        <input type="radio" name="qosmode" value="2">
                        Manual
                        <input type="radio" name="qosmode" value="1">
                        Smart</div>
                </div>
                <div id="intCtrContent">
                    <div class="control-group">
                        <label class="control-label">Total Bandwidth of AP</label>
                        <div class="controls">
                            <input type="text" id="apWidth" name="overAllBand" maxlength="32" value=""><span class="text-help">Mbps (Range: 0.1~100)</span>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">Select Enabled SSID</label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">Max Upload Rate:
                            <input type="text" class="input-mini" id="intUpWidth" name="ssid_uprate" maxlength="32" value=""><span class="text-help">Mbps (Range: 0.1~100)</span>
                        </div>

                    </div>
                    <div class="control-group">
                        <label class="control-label"></label>
                        <div class="controls">Max Download Rate:
                             <input type="text" class="input-mini" id="intDownWidth" name="ssid_downrate" maxlength="32" value=""><span class="text-help">Mbps (Range: 0.1~100)</span>
                        </div>
                    </div>
                    ...
                    <table class="w640 tc ml20" border="1" id="intCtrTab">
                        ...
                        <tbody id="intCtrTabContent"></tbody>
                    </table>
                </div>
                <div id="userCtrContent">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            Max Upload Rate:
                           <input type="text" class="input-mini" id="userUpWidth" name="ssid_uprate" maxlength="32" value=""><span class="text-help">Mbps (Range: 0.1~100)</span>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label"></label>
                        <div class="controls">
                            Max Download Rate:
                           <input type="text" class="input-mini" id="userDownWidth" name="ssid_downrate" maxlength="32" value=""><span class="text-help">Mbps (Range: 0.1~100)</span>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            Max Upload Rate:
                           <input type="text" class="input-mini" id="userSelfUpWidth" name="guest_uprate" maxlength="32" value=""><span class="text-help">Mbps (Range: 0.1~100)</span>
                        </div>
                    </div>
                    <div class="control-group">
                        <label id="userCtrSSID" class="control-label"></label>
                        <div class="controls">
                            Max Download Rate:
                           <input type="text" class="input-mini" id="userSelfDownWidth" name="guest_downrate" maxlength="32" value=""><span class="text-help">Mbps (Range: 0.1~100)</span>
                        </div>
                    </div>
                    ...
                    <table class="w640 tc ml20 table-td" border="1" id="userCtrTab">
                        ...
                        <tbody id="userCtrTabContent"></tbody>
                    </table>
                </div>
                </div>
            </form>
